# -*- coding: utf-8 -*-
"""4A-LORIN-EXER2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1q7MwQz1CGMiMRIoQOwzwcRiSWbAAPcwX
"""
...
# Load the image
image = cv2.imread('/content/sample.jpg')  # Replace 'your_image.jpg' with the actual path to your image
gray_image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
# Load two images
image1 = cv2.imread('/content/sample.jpg', 0)
image2 = cv2.imread('/content/sample2.jpg', 0)
...
# Load two images
image1 = cv2.imread('/content/sample.jpg', cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread('/content/sample2.jpg', cv2.IMREAD_GRAYSCALE)
...
# prompt: create a compilation of all the processed images, save it to a pdf

import matplotlib.pyplot as plt
from matplotlib.backends.backend_pdf import PdfPages

# Assuming you have the following variables from your previous code:
# image_with_keypoints (SIFT), image_with_keypoints (SURF), image_with_keypoints (ORB), image_matches (feature matching), result (image alignment)
...
print("PDF saved as processed_images.pdf")